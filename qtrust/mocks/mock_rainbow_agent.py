"""
Mock implementation of Rainbow DQN Agent for testing.

This module provides a mock implementation of the Rainbow DQN Agent
for testing purposes without requiring PyTorch.
"""
...
class MockRainbowDQNAgent:
    ...
    def __init__(self, state_dim: int, action_dim: int, config: Dict[str, Any] = None):
        ...
        logger.info(
            f"Initialized MockRainbowDQNAgent with state_dim={state_dim}, action_dim={action_dim}"
        )
